...
export const navItems: NavItem[] = [
  ...
  { key: 'markApproval', label: 'Pengesahan Markah', href: '/pengesahan-markah', roles: ['OWNER', 'ADMIN_DAERAH', 'ADMIN_ZON', 'ADMIN_SEKOLAH', 'GURU_KELAS', 'GURU_SUBJEK'] },
  ...
  { key: 'notifications', label: 'Notifikasi', href: '/notifikasi', roles: allRoles },
