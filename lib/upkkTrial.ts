...
export type UpkkWrittenMark = { id: string; kod_sekolah: string; tahun_akademik: number; class_id: string; student_id: string; paper_code: string; markah: number; updated_at: string };
