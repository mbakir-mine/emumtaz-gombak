  ...
  },
  {
    ...
    groups: [
      ...
      { code: 'B15', title: 'Tertib', items: [{ code: 'B15.1', label: 'Tertib', max: 1 }] },
      {
        ...
        title: 'Niat Solat',
        items: [
          { code: 'B16.1', label: 'Niat solat Zohor', max: 1 },
          { code: 'B16.2', label: 'Niat solat Asar', max: 1 },
          { code: 'B16.3', label: 'Niat solat Maghrib', max: 1 },
          { code: 'B16.4', label: 'Niat solat Isyak', max: 1 },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        title: 'Wirid',
        items: [
          { code: 'C1.1', label: 'Membaca Astaghfirullah al-azim', max: 1 },
          { code: 'C1.2', label: 'Membaca La ilaha illallah wahdahu la syarikalah', max: 1 },
          { code: 'C1.3', label: 'Membaca Allahumma ajirna minan nar', max: 1 },
          { code: 'C1.4', label: 'Membaca Allahumma antas salam', max: 1 },
          { code: 'C1.5', label: 'Membaca surah al-Fatihah', max: 1 },
          { code: 'C1.6', label: 'Membaca ayat al-Kursi', max: 1 },
          { code: 'C1.7', label: 'Membaca Subhanallah 33 kali', max: 1 },
          { code: 'C1.8', label: 'Membaca Alhamdulillah 33 kali', max: 1 },
          { code: 'C1.9', label: 'Membaca Allahu Akbar 33 kali', max: 1 },
          { code: 'C1.10', label: 'Membaca Allahu Akbar kabira', max: 1 },
        ],
      },
      {
        code: 'C2',
