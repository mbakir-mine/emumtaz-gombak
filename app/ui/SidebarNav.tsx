...
const groupedMenu = [
  ...
  },
  {
    ...
    label: 'Modul Sekolah',
    href: '/kehadiran',
    items: ['calendar', 'attendance', 'amalKhair', 'pbd', 'upkkAssessment', 'upkkTrial', 'psraTrial', 'khalifahMuda', 'timetable', 'rph'],
  },
  {
    key: 'scoring',
    label: 'Pemarkahan',
  ...
  },
  {
    ...
    label: 'Tetapan',
    href: '/setup',
    items: ['setup', 'componentMarks', 'khalifahMudaComponents', 'users', 'schoolModules', 'changePassword'],
  },
];
...
const childLabels: Record<string, string> = {
  ...
  khalifahMudaComponents: 'Komponen IHAB',
  marks: 'Kelas',
