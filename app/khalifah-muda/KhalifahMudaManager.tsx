  ...
  if (selectableSchools.length === 0) {
    return (
      <section className="panel optional-module-panel">
        <h2>Modul Sahsiah IHAB belum diaktifkan</h2>
    ...
    <section className="panel optional-module-panel khalifah-panel">
      <div className="panel-head">
        <div>
          <h2>Sahsiah IHAB</h2>
          <p className="table-note">
            Rekod pentaksiran sahsiah berasaskan peristiwa untuk murid Tahun {KHALIFAH_MUDA_YEAR}. Guru merekod perkara penting,
      ...
      {yearSixClasses.length === 0 ? (
        ...
        <>
          ...
          <p className="empty">Belum ada rekod Sahsiah IHAB untuk kelas ini.</p>
                ) : (
                  <div className="table-scroll">
                    <table>
                      <thead>
